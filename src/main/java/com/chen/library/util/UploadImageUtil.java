...
public class UploadImageUtil {
	...
	public InputStream ImageRate(CommonsMultipartFile multipartFile, String filePath) throws IOException {
		...
		// 图片缩略图实现
		bufferedImage.getGraphics().drawImage(image.getScaledInstance(newWidth, newHeight, image.SCALE_SMOOTH), 0, 0,
				null);// *image/jpeg?
		...
		// 上传ftp
		// (!FtpUtils.uploadFile(thumbnailPath,thuis))
		return thuis;
